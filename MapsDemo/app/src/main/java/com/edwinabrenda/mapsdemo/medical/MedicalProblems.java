package com.edwinabrenda.mapsdemo.medical;
...
import com.edwinabrenda.mapsdemo.HomePage;
import com.edwinabrenda.mapsdemo.R;
import com.edwinabrenda.mapsdemo.adapter.CustomMedicalProblemsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                fillProblemsImages();
                fillProblemsText();
                com.edwinabrenda.mapsdemo.adapter.CustomMedicalProblemsAdapter customMedicalProblemsAdapter = new CustomMedicalProblemsAdapter(MedicalProblems.this, problemsImages, problemsText);
