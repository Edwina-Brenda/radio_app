...
public class LoginActivity extends AppCompatActivity {
    ...
    TextView account;
    com.edwinabrenda.mapsdemo.SqliteHelper sqliteHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqliteHelper=new com.edwinabrenda.mapsdemo.SqliteHelper(this);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(validate()){
                    ...
                    com.edwinabrenda.mapsdemo.User currentUser=sqliteHelper.Authenticate(new com.edwinabrenda.mapsdemo.User(null,null,mail,null,pass,null));
                    if(currentUser!=null){
    ...
    public void initCreateAccountTextView(){
        ...
        account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(LoginActivity.this, com.edwinabrenda.mapsdemo.SignUpActivity.class);
                startActivity(intent);
            }
        });
    }
