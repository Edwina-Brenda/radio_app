...
import com.edwinabrenda.mapsdemo.medical.MedicalProblems;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            case R.id.home:
                ...
                break;
            case R.id.contact:
                Intent p=new Intent(HomePage.this, com.edwinabrenda.mapsdemo.Contact.class);
                p.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(p);
                break;
            case R.id.about:
                Intent a=new Intent(HomePage.this, com.edwinabrenda.mapsdemo.AboutActivity.class);
                a.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(a);
                break;
            case R.id.help:
                Intent help=new Intent(HomePage.this, com.edwinabrenda.mapsdemo.HelpActivity.class);
                help.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(help);
                break;
            case R.id.logout:
                Toast.makeText(getApplicationContext(),"Logout successful",Toast.LENGTH_SHORT).show();
                Intent logout=new Intent(HomePage.this, com.edwinabrenda.mapsdemo.LoginActivity.class);
